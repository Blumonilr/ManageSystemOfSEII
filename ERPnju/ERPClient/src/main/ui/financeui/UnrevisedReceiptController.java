...
public class UnrevisedReceiptController {
    @FXML
    ...
    public void init(FinanceMainUIController financeMainUIController){
        ...
        try {
            list=financeblService.readUnrevisedReceiptList(currentUserId);
    ...
    public void onLookUp(){
        ...
        try {
            receipt = financeblService.readUnrevisedReceipt(receiptID);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
