...
public class ModifyPurchaseReturnController {
	...
	PurchaseReturnReceiptVO current;
...
//		this.operatorId.setText(currentUserId);
	...
	public void modify() {
		if(checkComplete()){
			PurchaseReturnReceiptVO purchaseReceipt=null;
			...
			purchaseReceipt=new PurchaseReturnReceiptVO(current.getId(),current.getMakeTime(),null,operatorid,clientid,stockid,Note,itemList);
			try {
