...
import main.ui.saleui.GiftReceiptUIController;
import main.ui.saleui.UtilChooseStrategyUIController;
import main.ui.saleui.EditSaleReturnReceiptUIController.TableNode;
...
public class ModifySaleReturnController {
	...
	public void modify() {
		...
		if(checkComplete()){
			...
			SaleReturnReceiptVO receipt=getReceiptFromUI();
			try {
				if(RemoteHelper.getInstance().getReviseblService().updateReceipt(receipt)){
