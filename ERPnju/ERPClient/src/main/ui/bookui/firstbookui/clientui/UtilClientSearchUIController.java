...
public class UtilClientSearchUIController {
	...
	public void search(){
		...
		for(ClientVO vo:list){
			Client c=new Client(vo.getClientName(),vo.getID(),vo.getType(),vo.getPhone());
			clientList.add(c);
		}
	...
	class Client extends RecursiveTreeObject<Client>{
		...
		public Client(String name, String id, String type, String telephone) {
			super();
