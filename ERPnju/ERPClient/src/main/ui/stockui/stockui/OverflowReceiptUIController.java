...
public class OverflowReceiptUIController {
	...
	public void onMake(){
		...
		try{
			...
			if(goodsName.equals("")){
				...
				StockOverflowReceiptVO vo=new StockOverflowReceiptVO(null,Calendar.getInstance(),null,ClientRunner.getUser(),goodsName,goodsId,goodsXh,amount);
				boolean res=false;
				try{
